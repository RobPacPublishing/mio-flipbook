...
// Aggiungi supporto per messaggi esterni
...
// Invia informazioni sulle pagine alla finestra principale
...
// Aggiungi effetto di transizione pagina
document.addEventListener('pagechange', function() {
    const pageContainer = document.querySelector('.page');
    if (pageContainer) {
        pageContainer.style.transition = 'transform 0.3s ease-in-out, opacity 0.3s ease-in-out';
        pageContainer.style.opacity = '0.8';
        pageContainer.style.transform = 'translateX(-20px)';
...
// Modifica l'interfaccia per renderla più adatta a un flipbook
window.addEventListener('DOMContentLoaded', function() {
    // Aspetta che PDF.js sia completamente caricato
    setTimeout(() => {
        // Nascondi alcuni controlli non necessari
        ...
        // Invia informazioni sulle pagine
        updatePageInfo();
    }, 1000);
});